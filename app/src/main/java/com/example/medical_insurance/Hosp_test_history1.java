...
public class Hosp_test_history1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hosp_test_history1);
        ...
        String url= "http://"+sh.getString("ip","")+":5000/hosp_test_history1";
        RequestQueue queue = Volley.newRequestQueue(Hosp_test_history1.this);
